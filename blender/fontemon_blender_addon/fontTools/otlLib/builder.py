...
from fontemon_blender_addon.fontTools.misc.fixedTools import fixedToFloat
...
from fontemon_blender_addon.fontTools.ttLib.tables.otBase import (
    ValueRecord,
    valueRecordFormatDict,
    OTTableWriter,
    CountReference,
)
from fontemon_blender_addon.fontTools.ttLib.tables import otBase
from fontemon_blender_addon.fontTools.otlLib.error import OpenTypeLibError
import logging
import copy
...
class AlternateSubstBuilder(LookupBuilder):
    ...
    Attributes:
        font (``fontemon_blender_addon.fontTools.TTLib.TTFont``): A font object.
...
def buildSingleSubstSubtable(mapping):
    ...
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.SingleSubstBuilder` instead.
...
def buildMultipleSubstSubtable(mapping):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.MultipleSubstBuilder` instead.
...
def buildAlternateSubstSubtable(mapping):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.AlternateSubstBuilder` instead.
...
def buildLigatureSubstSubtable(mapping):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.LigatureSubstBuilder` instead.
    ...
    # with fontemon_blender_addon.fontTools >= 3.1:
...
def buildMarkBasePos(marks, bases, glyphMap):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.MarkBasePosBuilder` instead.
...
def buildMarkLigPos(marks, ligs, glyphMap):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.MarkLigPosBuilder` instead.
...
def buildPairPosClassesSubtable(pairs, glyphMap, valueFormat1=None, valueFormat2=None):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.ClassPairPosSubtableBuilder`
...
def buildPairPosGlyphs(pairs, glyphMap):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.PairPosBuilder`
    instead.
...
def buildPairPosGlyphsSubtable(pairs, glyphMap, valueFormat1=None, valueFormat2=None):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.PairPosBuilder` instead.
...
def buildSinglePos(mapping, glyphMap):
    ...
    Note that if you are implementing a layout compiler, you may find it more
    flexible to use
    :py:class:`fontemon_blender_addon.fontTools.otlLib.lookupBuilders.SinglePosBuilder` instead.
