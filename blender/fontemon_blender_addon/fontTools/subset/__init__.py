...
from fontemon_blender_addon.fontTools.ttLib.tables import otTables
from fontemon_blender_addon.fontTools.otlLib.maxContextCalc import maxCtxFont
from fontemon_blender_addon.fontTools.pens.basePen import NullPen
from fontemon_blender_addon.fontTools.misc.loggingTools import Timer
from fontemon_blender_addon.fontTools.subset.cff import *
from fontemon_blender_addon.fontTools.varLib import varStore
import sys
import struct
import array
import logging
...
pyftsubset -- OpenType font subsetter and optimizer
  ...
  pyftsubset is an OpenType font subsetter and optimizer, based on fontemon_blender_addon.fontTools.
...
Font naming options:
  ...
  --name-legacy
      ...
      entires for English. See: https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/146
  --no-name-legacy
...
log = logging.getLogger("fontemon_blender_addon.fontTools.subset")
...
timer = Timer(logger=logging.getLogger("fontemon_blender_addon.fontTools.subset.timer"))
...
def subset_features(self, feature_indices):
	...
	# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/1881
...
def subset_glyphs(self, s):
	...
	# Prune empty strikes
	# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/1633
...
def retain_empty_scripts(self):
	# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/518
...
class Options(object):
	...
	def __init__(self, **kwargs):
		...
		self.name_IDs = [0, 1, 2, 3, 4, 5, 6] # https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/1170#issuecomment-364631225
