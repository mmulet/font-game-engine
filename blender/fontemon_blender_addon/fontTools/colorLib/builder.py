...
from fontemon_blender_addon.fontTools.ttLib.tables import C_O_L_R_
from fontemon_blender_addon.fontTools.ttLib.tables import C_P_A_L_
from fontemon_blender_addon.fontTools.ttLib.tables import _n_a_m_e
from fontemon_blender_addon.fontTools.ttLib.tables.otBase import BaseTable
from fontemon_blender_addon.fontTools.ttLib.tables import otTables as ot
from fontemon_blender_addon.fontTools.ttLib.tables.otTables import (
    ExtendMode,
    CompositeMode,
    VariableValue,
    VariableFloat,
...
def buildAffine2x3(transform: _AffineTuple) -> ot.Affine2x3:
    ...
    # Affine Transformation as the one used by fontemon_blender_addon.fontTools.misc.transform.
