...
from fontemon_blender_addon.fontTools.pens.basePen import AbstractPen, DecomposingPen
from fontemon_blender_addon.fontTools.pens.pointPen import AbstractPointPen
