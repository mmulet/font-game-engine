...
from fontemon_blender_addon.fontTools.pens.filterPen import FilterPen, FilterPointPen
...
class TransformPen(FilterPen):
	...
	def __init__(self, outPen, transformation):
		...
		be a six-tuple, or a fontemon_blender_addon.fontTools.misc.transform.Transform object.
		"""
		super(TransformPen, self).__init__(outPen)
		if not hasattr(transformation, "transformPoint"):
			from fontemon_blender_addon.fontTools.misc.transform import Transform
...
class TransformPointPen(FilterPointPen):
	...
	>>> from fontemon_blender_addon.fontTools.pens.recordingPen import RecordingPointPen
	...
	def __init__(self, outPointPen, transformation):
		...
		fontemon_blender_addon.fontTools.misc.transform.Transform object.
		"""
...
if __name__ == "__main__":
	from fontemon_blender_addon.fontTools.pens.basePen import _TestPen
