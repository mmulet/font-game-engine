...
from fontemon_blender_addon.fontTools.cu2qu import curve_to_quadratic
from fontemon_blender_addon.fontTools.pens.basePen import AbstractPen, decomposeSuperBezierSegment
from fontemon_blender_addon.fontTools.pens.reverseContourPen import ReverseContourPen
from fontemon_blender_addon.fontTools.pens.pointPen import BasePointToSegmentPen
from fontemon_blender_addon.fontTools.pens.pointPen import ReverseContourPointPen


class Cu2QuPen(AbstractPen):
    """ A filter pen to convert cubic bezier curves to quadratic b-splines
    using the fontemon_blender_addon.fontTools SegmentPen protocol.
        ...
        for i, (segment_type, points) in enumerate(segments):
            if segment_type in ("move", "line"):
                ...
                if pt is None:
                    ...
                    # protocol's qCurveTo() method and fontemon_blender_addon.fontTools.pens.basePen
                    pass
                else:
                    pen.addPoint(pt, segment_type, smooth, name, **kwargs)
            else:
