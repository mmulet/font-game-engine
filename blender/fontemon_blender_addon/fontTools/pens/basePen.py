"""fontemon_blender_addon.fontTools.pens.basePen.py -- Tools and base classes to build pen objects.
...
subclass is fontemon_blender_addon.fontTools.pens.transformPen.TransformPen.
...
BasePen subclasses are fontemon_blender_addon.fontTools.pens.boundsPen.BoundsPen and
fontemon_blender_addon.fontTools.pens.cocoaPen.CocoaPen.
...
from fontemon_blender_addon.fontTools.misc.loggingTools import LogMixin
...
class AbstractPen(object):
	...
	def addComponent(self, glyphName, transformation):
		...
		fontemon_blender_addon.fontTools.misc.transform module. More precisely: it should be a
...
class LoggingPen(LogMixin, AbstractPen):
	"""A pen with a `log` property (see fontemon_blender_addon.fontTools.misc.loggingTools.LogMixin)
	"""
	pass
