"""fontemon_blender_addon.fontTools.misc.encodingTools.py -- tools for working with OpenType encodings.
"""

from fontemon_blender_addon.fontTools.misc.py23 import *
import fontemon_blender_addon.fontTools.encodings.codecs
...
_encodingMap = {
	...
	1: { # Macintosh
		# See
		# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/236
