# -*- coding: utf-8 -*-
"""fontemon_blender_addon.fontTools.misc.bezierTools.py -- tools for working with Bezier path segments.
"""

from fontemon_blender_addon.fontTools.misc.arrayTools import calcBounds
