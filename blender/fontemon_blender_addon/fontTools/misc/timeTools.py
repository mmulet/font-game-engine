"""fontemon_blender_addon.fontTools.misc.timeTools.py -- tools for working with OpenType timestamps.
"""
...
def asctime(t=None):
	...
	See https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/455
	"""
	if t is None:
		t = time.localtime()
	s = "%s %s %2s %s" % (
