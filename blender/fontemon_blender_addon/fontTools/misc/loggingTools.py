...
def configLogger(**kwargs):
	...
	the handler to the top-level library logger ("fontemon_blender_addon.fontTools").
	...
	Args:
		...
		logger: Specifies the logger name or a Logger instance to be
			configured. (Defaults to "fontemon_blender_addon.fontTools" logger). Unlike ``basicConfig``,
	...
	logger = kwargs.pop("logger", "fontemon_blender_addon.fontTools")
...
class LogMixin(object):
	...
	True
	>>> print(a.log.name)
	fontemon_blender_addon.fontTools.misc.loggingTools.MyClass
	...
	True
	>>> print(b.log.name)
	fontemon_blender_addon.fontTools.misc.loggingTools.AnotherClass
	"""
