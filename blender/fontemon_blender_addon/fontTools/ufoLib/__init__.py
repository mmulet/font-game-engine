...
from fontemon_blender_addon.fontTools.ufoLib.converters import convertUFO1OrUFO2KerningToUFO3Kerning
from fontemon_blender_addon.fontTools.ufoLib.errors import UFOLibError
...
class UFOReader(_UFOBaseIO):
	...
	def getGlyphSet(self, layerName=None, validateRead=None, validateWrite=None):
		...
		class's validate value, can be overridden.
		"""
		from fontemon_blender_addon.fontTools.ufoLib.glifLib import GlyphSet
...
class UFOWriter(UFOReader):
	...
	def __init__(
		...
		path,
		formatVersion=None,
		fileCreator="com.github.fontemon_blender_addon.fontTools.ufoLib",
		structure=None,
		validate=True,
	):
		try:
