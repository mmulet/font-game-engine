...
import fs.osfs
import fs.path
from fontemon_blender_addon.fontTools.misc.py23 import tobytes
from fontemon_blender_addon.fontTools.misc import plistlib
from fontemon_blender_addon.fontTools.pens.pointPen import AbstractPointPen, PointToSegmentPen
from fontemon_blender_addon.fontTools.ufoLib.errors import GlifLibError
from fontemon_blender_addon.fontTools.ufoLib.filenames import userNameToFileName
from fontemon_blender_addon.fontTools.ufoLib.validators import (
...
from fontemon_blender_addon.fontTools.misc import etree
from fontemon_blender_addon.fontTools.ufoLib import _UFOBaseIO, UFOFormatVersion
from fontemon_blender_addon.fontTools.ufoLib.utils import numberTypes, _VersionTupleEnumMixin
...
class Glyph:
	...
	def draw(self, pen):
		"""
		Draw this glyph onto a *fontemon_blender_addon.fontTools* Pen.
		"""
...
class GlyphSet(_UFOBaseIO):
	...
	def __init__(
		...
		try:
			...
			from fontemon_blender_addon.fontTools.ufoLib.errors import UnsupportedUFOFormat
	...
	def writeGlyph(self, glyphName, glyphObject=None, drawPointsFunc=None, formatVersion=None, validate=None):
		...
		if formatVersion is None:
			...
			try:
				...
				from fontemon_blender_addon.fontTools.ufoLib.errors import UnsupportedGLIFFormat
