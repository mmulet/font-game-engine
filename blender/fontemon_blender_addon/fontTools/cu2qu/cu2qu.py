...
try:
    ...
    from fontemon_blender_addon.fontTools.misc import cython
...
def curves_to_quadratic(curves, max_errors):
    ...
    Raises:
        fontemon_blender_addon.fontTools.cu2qu.Errors.ApproxNotFoundError: if no suitable approximation
