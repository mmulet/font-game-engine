...
as decompiling :class:`fontemon_blender_addon.fontTools.misc.psCharStrings.T2CharString` objects
...
from fontemon_blender_addon.fontTools.cffLib import maxStackLimit
