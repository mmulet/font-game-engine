...
from fontemon_blender_addon.fontTools.misc import psCharStrings
from fontemon_blender_addon.fontTools.misc.arrayTools import unionRect, intRect
...
from fontemon_blender_addon.fontTools.ttLib.tables.otBase import OTTableReader
from fontemon_blender_addon.fontTools.ttLib.tables import otTables as ot
import struct
import logging
import re
# from lap import Lap
...
class CFFFontSet(object):
	...
	.. code:: python
		...
		tt["CFF "].cff
		# <fontemon_blender_addon.fontTools.cffLib.CFFFontSet object at 0x101e24c90>
		tt["CFF "].cff[0] # Here's your actual font data
		# <fontemon_blender_addon.fontTools.cffLib.TopDict object at 0x1020f1fd0>
	...
	def decompile(self, file, otFont, isCFF2=None):
		...
		:py:class:`fontemon_blender_addon.fontTools.ttLib.ttFont.TTFont` object containing this CFF file.
	...
	def toXML(self, xmlWriter):
		...
		:class:`fontemon_blender_addon.fontTools.misc.xmlWriter.XMLWriter`.
...
class TopDictIndex(Index):
	...
	.. code:: python
		...
		tt["CFF "].cff[0]
		# <fontemon_blender_addon.fontTools.cffLib.TopDict object at 0x102ed6e50>
...
class CharStrings(object):
	...
	See :class:`fontemon_blender_addon.fontTools.misc.psCharStrings.T1CharString` and
	:class:`fontemon_blender_addon.fontTools.misc.psCharStrings.T2CharString` for how to decompile,
...
class BaseDict(object):
	...
	def __getattr__(self, name):
		if name[:2] == name[-2:] == "__":
			...
			# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/pull/1488
...
class FontDict(BaseDict):
	#
	# Since fontemon_blender_addon.fontTools used to pass a lot of fields that are not relevant in the FDArray
	# FontDict, there are 'ttx' files in the wild that contain all these. These got in
	# the ttx files because fontemon_blender_addon.fontTools writes explicit values for all the TopDict default
	...
	#
	# See:
	# - https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/740
	# - https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/601
