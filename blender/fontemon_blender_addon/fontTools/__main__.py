...
def main(args=None):
	...
	#
	#   $ fontemon_blender_addon.fontTools --unicodedata=... fontmake ...
	#
	# This allows for a git-like command where thirdparty commands
	# can be added.  Should we just try importing the fontemon_blender_addon.fontTools
	...
	if sys.argv[1] == "-h" or sys.argv[1] == "--help":
		sys.argv[1] = "help"
	mod = 'fontemon_blender_addon.fontTools.'+sys.argv[1]
