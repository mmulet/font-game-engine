...
class FontBuilder(object):
    ...
    def setupGlyf(self, glyphs, calcGlyphBounds=True):
        ...
        to `fontemon_blender_addon.fontTools.ttLib.tables._g_l_y_f.Glyph` objects, for example
        as made by `fontemon_blender_addon.fontTools.pens.ttGlyphPen.TTGlyphPen`.
    ...
    def addOpenTypeFeatures(self, features, filename=None, tables=None):
        ...
        `fontemon_blender_addon.fontTools.feaLib` for details.
        """
    ...
    def addFeatureVariations(self, conditionalSubstitutions, featureTag="rvrn"):
        ...
        See `fontemon_blender_addon.fontTools.varLib.featureVars.addFeatureVariations`.
        """
    ...
    def setupCOLR(self, colorLayers):
        ...
        Cf. `fontemon_blender_addon.fontTools.colorLib.builder.buildCOLR`.
        """
        from fontemon_blender_addon.fontTools.colorLib.builder import buildCOLR
    ...
    def setupCPAL(
        ...
        Cf. `fontemon_blender_addon.fontTools.colorLib.builder.buildCPAL`.
        """
        from fontemon_blender_addon.fontTools.colorLib.builder import buildCPAL
    ...
    def setupStat(self, axes, locations=None, elidedFallbackName=2):
        ...
        See `fontemon_blender_addon.fontTools.otlLib.builder.buildStatTable` for details about
        the arguments.
        """
