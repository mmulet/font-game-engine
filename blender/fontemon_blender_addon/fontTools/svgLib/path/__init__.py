...
class SVGPath(object):
    ...
    onto a glyph object that supports the fontemon_blender_addon.fontTools Pen protocol.
    ...
    tuple, or a fontemon_blender_addon.fontTools Transform object) to modify the draw output.
    """
