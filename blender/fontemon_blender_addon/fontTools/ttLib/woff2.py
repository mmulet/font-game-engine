...
from fontemon_blender_addon.fontTools.misc.arrayTools import calcIntBounds
from fontemon_blender_addon.fontTools.misc.textTools import pad
from fontemon_blender_addon.fontTools.ttLib import (TTFont, TTLibError, getTableModule, getTableClass,
	getSearchRange)
from fontemon_blender_addon.fontTools.ttLib.sfnt import (SFNTReader, SFNTWriter, DirectoryEntry,
...
log = logging.getLogger("fontemon_blender_addon.fontTools.ttLib.woff2")
...
def main(args=None):
	...
	from fontemon_blender_addon.fontTools.ttx import makeOutputFileName
	...
	parser = argparse.ArgumentParser(
		prog="fontemon_blender_addon.fontTools ttLib.woff2",
