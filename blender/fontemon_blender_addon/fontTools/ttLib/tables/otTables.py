# coding: utf-8
"""fontemon_blender_addon.fontTools.ttLib.tables.otTables -- A collection of classes representing the various
OpenType subtables.
...
from fontemon_blender_addon.fontTools.misc.textTools import pad, safeEval
from .otBase import (
	BaseTable, FormatSwitchingBaseTable, ValueRecord, CountReference,
	getFormatSwitchingBaseTableClass,
)
from fontemon_blender_addon.fontTools.feaLib.lookupDebugInfo import LookupDebugInfo, LOOKUP_DEBUG_INFO_KEY
import logging
import struct
...
class VarIdxMap(BaseTable):
	...
	def fromXML(self, name, attrs, content, font):
		...
		try:
			glyph = attrs['glyph']
		except: # https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/commit/21cbab8ce9ded3356fef3745122da64dcaf314e9#commitcomment-27649836
