...
from fontemon_blender_addon.fontTools.misc.textTools import safeEval, pad
from fontemon_blender_addon.fontTools.misc.arrayTools import calcBounds, calcIntBounds, pointInRect
from fontemon_blender_addon.fontTools.misc.bezierTools import calcQuadraticBounds
...
class table__g_l_y_f(DefaultTable.DefaultTable):
	...
	def setCoordinates(self, glyphName, coord, ttFont):
		...
		if horizontalAdvanceWidth < 0:
			...
			# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/pull/1198
...
class GlyphComponent(object):
	...
	def getComponentInfo(self):
		...
		# something equivalent in fontemon_blender_addon.fontTools.objects.glyph (I'd rather not
