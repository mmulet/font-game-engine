...
class OTTableWriter(object):
	...
	def _doneWriting(self, internedTables):
		...
		# See: https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/518
	...
	def getOverflowErrorRecord(self, item):
		...
		# elif item.name == 'Lookup':
			...
			# elif item.name == 'ExtSubTable':
				...
				# itemName = ".".join([item.name, itemName])
				p1 = self.parent
