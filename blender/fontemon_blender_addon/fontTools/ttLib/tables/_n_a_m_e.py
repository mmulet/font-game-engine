...
class table__n_a_m_e(DefaultTable.DefaultTable):
	...
	def addMultilingualName(self, names, ttFont=None, nameID=None,
		...
		# https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/930
		for lang, name in sorted(names.items()):
			if windows:
...
def _makeWindowsName(name, nameID, language):
	...
	Future versions of fontemon_blender_addon.fontTools might return a NameRecord for the
	...
	if langID is not None:
		...
		log.warning("cannot add Windows name in language %s "
		            "because fontemon_blender_addon.fontTools does not yet support "
