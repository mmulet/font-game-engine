...
$ fontemon_blender_addon.fontTools varLib.instancer ./NotoSans-VF.ttf wdth=85 wght=400:700

See `fontemon_blender_addon.fontTools varLib.instancer --help` for more info on the CLI options.
...
This module is similar to fontemon_blender_addon.fontTools.varLib.mutator, which it's intended to supersede.
...
https://github.com/fontemon_blender_addon.fontTools/fontemon_blender_addon.fontTools/issues/1537
"""
...
from fontemon_blender_addon.fontTools.varLib.models import supportScalar, normalizeValue, piecewiseLinearMap
...
from fontemon_blender_addon.fontTools import subset  # noqa: F401
from fontemon_blender_addon.fontTools.varLib import builder
from fontemon_blender_addon.fontTools.varLib.mvar import MVAR_ENTRIES
from fontemon_blender_addon.fontTools.varLib.merger import MutatorMerger
...
log = logging.getLogger("fontemon_blender_addon.fontTools.varLib.instancer")
    ...
    if "fvar" not in varfont:
        if "glyf" in varfont:
            if overlap == OverlapMode.KEEP_AND_SET_FLAGS:
                ...
                from fontemon_blender_addon.fontTools.ttLib.removeOverlaps import removeOverlaps
...
def parseArgs(args):
    ...
    parser = argparse.ArgumentParser(
        "fontemon_blender_addon.fontTools varLib.instancer",
