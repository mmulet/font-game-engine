...
from fontemon_blender_addon.fontTools.varLib.models import VariationModel, supportScalar
...
def main(args=None):
	...
	if len(args) < 1:
		print("usage: fontemon_blender_addon.fontTools varLib.plot source.designspace", file=sys.stderr)
		print("  or")
		print("usage: fontemon_blender_addon.fontTools varLib.plot location1 location2 ...", file=sys.stderr)
		sys.exit(1)
