...
$ fontemon_blender_addon.fontTools varLib.mutator ./NotoSansArabic-VF.ttf wght=140 wdth=85
"""
from fontemon_blender_addon.fontTools.misc.fixedTools import floatToFixedToFloat, otRound, floatToFixed
...
from fontemon_blender_addon.fontTools.ttLib.tables._g_l_y_f import GlyphCoordinates, flagOverlapSimple, OVERLAP_COMPOUND
from fontemon_blender_addon.fontTools.varLib.models import (
	supportScalar,
	normalizeLocation,
	piecewiseLinearMap,
)
from fontemon_blender_addon.fontTools.varLib.merger import MutatorMerger
from fontemon_blender_addon.fontTools.varLib.varStore import VarStoreInstancer
from fontemon_blender_addon.fontTools.varLib.mvar import MVAR_ENTRIES
from fontemon_blender_addon.fontTools.varLib.iup import iup_delta
import fontemon_blender_addon.fontTools.subset.cff
import os.path
import logging
from io import BytesIO


log = logging.getLogger("fontemon_blender_addon.fontTools.varlib.mutator")
...
def main(args=None):
	...
	parser = argparse.ArgumentParser(
		"fontemon_blender_addon.fontTools varLib.mutator", description="Instantiate a variable font")
	parser.add_argument(
