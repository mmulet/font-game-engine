...
from fontemon_blender_addon.fontTools.cffLib import (
	maxStackLimit,
	TopDictIndex,
	buildOrder,
	topDictOperators,
...
from fontemon_blender_addon.fontTools.cffLib.specializer import (
	specializeCommands, commandsToProgram)
from fontemon_blender_addon.fontTools.ttLib import newTable
from fontemon_blender_addon.fontTools import varLib
from fontemon_blender_addon.fontTools.varLib.models import allEqual
from fontemon_blender_addon.fontTools.misc.psCharStrings import T2CharString, T2OutlineExtractor
from fontemon_blender_addon.fontTools.pens.t2CharStringPen import T2CharStringPen, t2c_round
...
class CFF2CharStringMergePen(T2CharStringPen):
	...
	def add_hintmask(self, hint_type, abs_args):
		# For hintmask, fontemon_blender_addon.fontTools.cffLib.specializer.py expects
