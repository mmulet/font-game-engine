...
from fontemon_blender_addon.fontTools.feaLib.location import FeatureLibLocation
...
class Block(Statement):
    ...
    def build(self, builder):
        ...
        :class:`fontemon_blender_addon.fontTools.feaLib.builder`, walks the statements in this
