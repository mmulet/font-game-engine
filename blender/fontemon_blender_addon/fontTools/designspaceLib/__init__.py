...
import os
import posixpath
from fontemon_blender_addon.fontTools.misc import etree as ET
...
class SourceDescriptor(SimpleDescriptor):
    ...
    def __init__(
        ...
        *,
        ...
        ``defcon.Font`` or a ``fontemon_blender_addon.fontTools.ttFont.TTFont``).
...
class AxisDescriptor(SimpleDescriptor):
    ...
    def map_forward(self, v):
        from fontemon_blender_addon.fontTools.varLib.models import piecewiseLinearMap
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    ...
    def normalizeLocation(self, location):
        from fontemon_blender_addon.fontTools.varLib.models import normalizeValue
    ...
    def loadSourceFonts(self, opener, **kwargs):
        ...
        Or to load masters as fontemon_blender_addon.fontTools binary fonts, including extra options:
